...
Вам не обязательно погружаться в эту страницу для обычной настройки.
...
Эта страница объясняет, что происходит «под капотом» для читателей, которые хотят более глубокое понимание, как всё работает.
