...
literal IPv4- или IPv6-адрес в записи группы.
...
Правила firewall сохраняют стабильную mark самого outbound `urltest`. Его
policy rule указывает на таблицу выбранного дочернего outbound, включая уже
существующую таблицу outbound типа `table`; при переключении правила firewall
не перестраиваются.
