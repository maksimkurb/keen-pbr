export const ruTranslation = {
  auth: {
    ...
    settings: {
      ...
      restartNotice:
        "Изменения аутентификации и CORS вступят в силу сразу после применения подготовленной конфигурации.",
      ...
      staged:
        "Настройки аутентификации подготовлены. Примените конфигурацию, чтобы активировать их.",
    },
  },
  common: {
    language: "Язык",
