...
export function SettingsForm() {
  ...
  const methods = useForm<GeneralConfig>({
    defaultValues: settings ?? defaultData,
    mode: 'onChange',
  });
  ...
  return (
    ...
    >
          ...
          <FieldGroup>
            ...
            <Field>
              ...
              <Input
                ...
                onChange={(e) =>
                  setValue('lists_output_dir', e.target.value, {
                    shouldDirty: true,
                  })
                }
              ...
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue('auto_update_lists.enabled', !!checked, {
                      shouldDirty: true,
                    })
                  }
                />
            ...
            <Field>
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  setValue('auto_update_lists.interval_hours', value, {
                    shouldDirty: true,
                  });
                }}
                placeholder="24"
            ...
            <Field orientation="horizontal">
              <div className="flex items-center space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue(
                      'interface_monitoring_interval_seconds',
                      checked ? 10 : 0,
                      { shouldDirty: true },
                    )
                  }
      ...
      <DNSServerSettings
        ...
        onChange={(dnsServer) =>
          setValue('dns_server', dnsServer, { shouldDirty: true })
        }
      />
    </BaseForm>
  );
